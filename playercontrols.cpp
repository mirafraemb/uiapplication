    ...
    : QWidget(parent)
{
    ...
    m_rateBox->setStyleSheet(QString::fromUtf8("background-color: rgb(0, 170, 220);color: rgb(220, 180, 0);font-weight:1200;font-family: Arial;font-style: italics;font-size: 12pt;"));
